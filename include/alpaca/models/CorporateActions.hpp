...
void from_json(Json const& j, CorporateActionAnnouncement& announcement);
...
void from_json(Json const& j, CorporateActionAnnouncementsResponse& response);
...
void from_json(Json const& j, CorporateActionEvent& event);
...
void from_json(Json const& j, CorporateActionEventsResponse& response);
